            ...
            <div class="modal-content">
                ...
                <form action="{{route('profile_update')}}"  method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="image">Profile Image</label>  <input type="file" class="btn-outline-success" id="name" name="image">
                        </div>
            ...
            <div class="col-sm-3 well">
                <div class="well">
                    ...
                    @if(!empty($friend->image))
                        <img src="{{url('uploads/'.$friend->image)}}" class="img-circle" title="{{$friend->name}}"  height="100" width="100"   alt="{{$friend->name}}">
                    @else
                        <img src="{{url('uploads/noprofile.png')}}" class="img-circle"  title="{{$friend->name}}" height="100" width="100" alt="{{$friend->name}}">
                    @endif
                </div>
                <div class="well">
                    <h4>Friends</h4>
